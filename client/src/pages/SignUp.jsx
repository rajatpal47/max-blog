      ...
      <div className=" flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-8">
        ...
        <div className=" flex-1">
          ...
          <p className=" text-sm mt-5">
            Join us today to access exclusive features and connect with like-minded   individuals. Start your journey with just a few simple steps!
          </p>
        </div>
        {/* right side  */}
        <div className=" flex-1">
          <form className=" flex flex-col gap-4" onSubmit={handleSubmit}>
            <div>
              ...
              <TextInput type="text" placeholder="max_name" id="username" onChange={handleChange}/>
            </div>
            <div>
